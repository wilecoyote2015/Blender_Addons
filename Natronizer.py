...
# TODO: Rewrite. Use the same principles as darktable addon:
#   Store natron file per strip and use rendering in analog way.
#   DRY by abstracting the render handlers from darktable.
#
# bl_info = {
#     "name": "Natronizer",
